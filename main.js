...
const langb = document.querySelector ('.lang');
...
langb.addEventListener ('click', getTranslate);
...
const navLinks = document.querySelectorAll('.nav-ref');
...
const portfolioImage = document.querySelectorAll('.img');
const portfolioBtns = document.querySelector('.portfolio-item');
